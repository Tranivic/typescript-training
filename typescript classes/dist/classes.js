...
class Department {
    ...
    removeEmployee(indexOrName) {
        if (typeof indexOrName === 'number') {
            ...
            const employeeToRemove = this.employees.find((employee) => employee === indexOrName);
            if (employeeToRemove) {
    ...
    printEmployees() {
        ...
        console.log(`Currently, we have a total of ${this.employees.length} employees called: ${employeesList}.`);
    }
}
